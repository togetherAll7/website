...
In addition to new interactions, React Three XR also provides new **capabilities** brought by WebXR itself. This includes mesh detection, plane detection, hit testing, DOM overlay, anchor API and even a [new testing emulator](https://x.com/BelaBohlender/status/1819378919344165264).
